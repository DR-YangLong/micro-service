package io.github.yanglong.demo.controller;
...
import io.github.yanglong.demo.config.shiro.PrincipalUtils;
import io.github.yanglong.demo.model.User;
import io.github.yanglong.demo.service.LoginService;
import io.github.yanglong.demo.vo.ResultVo;
...
public class LoginController {
    ...
    /**
     * 常规web登录，如果是JSON，可使用如下数据格式，前端使用js判断登录成功状态然后转向 example:{success:true/false,redirectPath:url}
     *
